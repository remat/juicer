...
static const char qt_meta_stringdata_Convert[] = {
    "Convert\0"
};

const QMetaObject Convert::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Convert,
      qt_meta_data_Convert, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Convert))
