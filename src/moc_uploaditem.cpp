/****************************************************************************
** Meta object code from reading C++ file 'uploaditem.h'
**
...
#error "The header file 'uploaditem.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_UploadItem[] = {
    "UploadItem\0"
};

const QMetaObject UploadItem::staticMetaObject = {
    { &Item::staticMetaObject, qt_meta_stringdata_UploadItem,
      qt_meta_data_UploadItem, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UploadItem))
        return static_cast<void*>(const_cast< UploadItem*>(this));
